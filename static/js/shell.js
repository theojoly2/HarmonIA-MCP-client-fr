...
class Shell {
        ...
        this.container.innerHTML = `
            <div id="global-header" class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200 px-4 sm:px-6 py-3 flex items-center justify-between flex-shrink-0">
                ...
                <div class="flex items-center gap-2">
                    <button id="btn-float-active" class="nav-tab" title="Fenêtre flottante">⧉</button>
                    <button id="btn-split-active" class="nav-tab" title="Split view">⧇</button>
                </div>
            </div>
    ...
    addAppButton(appClass) {
        ...
        btn.innerHTML = `${appClass.icon} ${appClass.title}`;
