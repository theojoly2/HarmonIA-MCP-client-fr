    ...
    render(container) {
        ...
        container.innerHTML = `
            <div class="preview-app h-full w-full flex flex-col relative bg-white">
                ...
                <button type="button" id="preview-expand" class="absolute top-3 right-3 z-20 p-2 rounded-full bg-white border border-gray-200 text-gray-600 hover:text-black hover:border-gray-400 shadow-sm transition-colors" title="Ouvrir dans Créer/Modifier">
